...
| <a name="input_powertools_layer_version"></a> [powertools\_layer\_version](#input\_powertools\_layer\_version) | The version of the Powertools Lambda layer to use. | `string` | `null` | no |
